...
/*****************************************************************************
 CLASS NAME    : EthernetSampleArchiveService
 DESCRIPTION   : ethernet_sample 테이블의 샘플 데이터를
 AbstractSampleArchiveService 템플릿 로직을 통해
 S3로 아카이브하고 삭제하는 서비스
 AUTHOR        : 방대혁
 ******************************************************************************/
/**
 * Ethernet Sample Archive Service
 */
@Service
public class EthernetSampleArchiveService extends AbstractSampleArchiveService {
     ...
     */
    private static final String TABLE_NAME = "ethernet_sample";

    /**
     * Ethernet 샘플 아카이브 서비스 생성자
     *
     * @param jdbcTemplate DB 접근용 JdbcTemplate
     * @param s3Uploader   S3 업로드 유틸
     * @param s3Props      S3 설정 정보 (버킷, prefix 등)
     */
    public EthernetSampleArchiveService(
