...
//    public ResponseEntity<ErrorPageResponseDTO> getTcpErrorRate(
...
//        }
//
//        ErrorPageResponseDTO result = widgetService.getTcpErrorRate(
//                timeRange.fromEpoch,
//                timeRange.toEpoch
//        );
//        return ResponseEntity.ok(result);
...
//    public ResponseEntity<List<CountryTrafficResponseDTO>> getTrafficByCountry(
...
//        }
//
//        List<CountryTrafficResponseDTO> result;
//
...
//    public ResponseEntity<StatusCodeResponseDTO> getHttpStatus(
...
//        }
//
//        StatusCodeResponseDTO result = widgetService.getHttpStatusCodeDistribution(
//                timeRange.fromEpoch,
//                timeRange.toEpoch
//        );
//        return ResponseEntity.ok(result);
